...
exports.ContextForgeChatProvider = void 0;
const vscode = require("vscode");
const axios_1 = require("axios");
class ContextForgeChatProvider {
    constructor(_extensionUri, _config) {
    ...
    async handleSendMessage(messageContent, attachments) {
        ...
        try {
            ...
            // Send to API
            const response = await axios_1.default.post(`${this._config.apiUrl}/chat`, {
    ...
    async handleFileUpload(file) {
        try {
            ...
            const response = await axios_1.default.post(`${this._config.apiUrl}/files/upload`, formData, {
                headers: {
...
exports.ContextForgeChatProvider = ContextForgeChatProvider;
ContextForgeChatProvider.viewType = 'contextforge.chatView';
