...
export class ContextForgePromptProvider implements vscode.WebviewViewProvider {
    ...
    private async _enhancePrompt(prompt: string, context?: string, style?: string) {
        try {
            ...
            const enhancement = response.data as PromptEnhancementResponse;
    ...
    private _useTemplate(templateId: string) {
    ...
    private _savePrompt(prompt: string, category: string) {
    ...
    private _toggleFavorite(promptId: string) {
